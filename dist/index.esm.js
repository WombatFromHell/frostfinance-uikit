...
import { space, typography, layout, variant as variant$1, background, border, position, flexbox, size } from 'styled-system';
...
var rotate$2 = keyframes(templateObject_1$Y || (templateObject_1$Y = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var templateObject_1$Y, templateObject_2$r, templateObject_3$f;
...
var StyledSVG = styled.svg(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n  animation: 2s ", " linear infinite;\n  height: ", ";\n  width: ", ";\n  path {\n    stroke: ", ";\n  }\n"], ["\n  animation: 2s ", " linear infinite;\n  height: ", ";\n  width: ", ";\n  path {\n    stroke: ", ";\n  }\n"])), rotate$1, function (_a) {
    var size = _a.size;
    return size;
}, function (_a) {
    var size = _a.size;
...
var StyledButton = styled.button(templateObject_1$U || (templateObject_1$U = __makeTemplateObject(["\n  align-items: center;\n  border-radius: 6px;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s ease, opacity 0.2s ease;\n\n  background-color: ", ";\n  color: ", ";\n\n  border: solid 3px transparent;\n  background-origin: border-box;\n  ", "\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border-radius: 6px;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s ease, opacity 0.2s ease;\n\n  background-color: ", ";\n  color: ", ";\n\n  border: solid 3px transparent;\n  background-origin: border-box;\n  ", "\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), getOpacity, function (_a) {
    ...
    var theme = _a.theme;
    return (theme.isDark ? theme.colors.primaryDark : theme.colors.primary);
}, function (props) {
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$1d, { width: "24px", fill: "white" }))))));
};
var templateObject_1$Q, templateObject_2$p, templateObject_3$e, templateObject_4$a;
...
var StyledBalanceInput = styled(Box)(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    ...
    return theme.colors.shadows
        ? theme.colors.shadows[isWarning ? "warning" : "inset"]
...
var templateObject_1$N, templateObject_2$n;
...
var ButtonMenu = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.scale, scale = _c === void 0 ? scales$5.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants$2.PRIMARY : _d, onItemClick = _a.onItemClick, children = _a.children;
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", "$colorKey": variant === variants$2.TOGGLE ? "primary" : "textSubtle" }, props)));
    }
...
var Container$3 = styled.div(templateObject_2$m || (templateObject_2$m = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var EXPBottleIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "-11 -5 29 31", style: { marginRight: "5px" } }, props),
        React.createElement("g", { transform: "translate(229.99757,-44.161136)" },
            React.createElement("g", { transform: "matrix(0.96969864,0,0,0.86890098,-6.9692352,5.7894797)" },
                React.createElement("path", { style: {
                        fillOpacity: 1,
                        strokeWidth: 0.264583,
                    }, d: "m -226.09478,67.917454 c -0.1885,-0.327422 -0.48014,-0.833438 -0.64807,-1.124479 -0.16793,-0.291042 -0.96894,-1.645649 -1.78003,-3.010237 -0.81108,-1.364589 -1.47469,-2.706595 -1.47469,-2.982235 0,-0.275641 0.28092,-0.945097 0.62426,-1.48768 0.34333,-0.542583 1.17798,-1.939015 1.85477,-3.103181 1.6357,-2.813639 1.
0.380406 0.39688,-0.561563 0.3238,-0.268731 0.39687,-0.253726 0.39687,0.08149 0,0.225979 0.26789,0.462468 0.59532,0.525532 0.36851,0.07098 0.21732,0.128389 -0.39688,0.150694 -0.5457,0.01982 -0.99219,-0.06845 -0.99219,-0.196155 z m 2.82223,-1.531702 c -0.097,-0.09701 -0.17639,-0.357896 -0.17639,-0.579737 0,-0.319617 0.074,-0.302072 0.35673,0.08452 0.22462,0.307188 0.48473,0.408763 0.70234,0.274273 0.22845,-0.141189 0.28161,-0.110047 0.15682,0.09187 -0.20778,0.336192 -0.7634,0.405182 -1.0395,0.129074 z", id: "path237" }),
                React.createElement("path", { style: {
                        fillOpacity: 1,
                        strokeWidth: 0.264583,
                    }, d: "m -226.27507,64.213287 c -0.8779,-1.491588 -1.59835,-2.913311 -1.601,-3.159385 -0.0112,-1.038787 0.49929,-0.569197 1.79954,1.655337 1.1077,1.895099 1.50303,2.363944 1.99325,2.363944 0.46835,0 0.67805,0.216804 0.89572,0.926042 l 0.28421,0.926041 h -0.88777 c -0.84576,0 -0.96333,-0.128364 -2.48395,-2.711979 z m 8.9775,1.562775 c 0,-0.833088 1.99122,-5.200795 2.37102,-5.200795 0.65841,0 0.45928,0.738666 -0.78557,2.914003 -1.18431,2.069547 -1.58545,2.648132 -1.58545,2.286792 z", id: "path235" }),
                React.createElement("path", { style: {
                        fillOpacity: 1,
                        strokeWidth: 0.264583,
                    }, d: "m -226.29092,64.130294 c -0.98416,-1.68377 -1.56991,-2.961117 -1.4733,-3.212869 0.20625,-0.537483 0.25841,-0.477471 1.7072,1.964326 0.76335,1.286552 1.41658,2.089444 1.748,2.148501 0.67932,0.121052 0.82027,0.280928 1.02921,1.16741 0.15723,0.667093 0.10708,0.727604 -0.60297,0.727604 -0.70426,0 -0.92257,-0.253379 -2.40814,-2.794972 z m 9.36465,0.546014 c 0.21828,-0.956397 1.77933,-4.101041 2.03582,-4.101041 0.54672,0 0.31931,0.882572 -0.6634,2.574637 -1.30969,2.255066 -1.61663,2.596453 -1.37242,1.526404 z", id: "path233" }),
                React.createElement("path", { style: {
                        fillOpacity: 1,
                        strokeWidth: 0.264583,
                    }, d: "m -224.75651,66.462246 c -0.8564,-0.998306 -3.16298,-5.345899 -2.98716,-5.630386 0.10948,-0.177146 0.67163,0.550008 1.3631,1.763213 1.43739,2.521962 1.61528,2.742693 2.21035,2.742693 0.28533,0 0.57993,0.312785 0.74759,0.79375 0.25504,0.731618 0.22921,0.79375 -0.32998,0.79375 -0.33368,0 -0.78543,-0.208359 -1.0039,-0.46302 z m 7.84922,-1.653646 c 0.22681,-0.858836 1.75391,-3.954532 2.0371,-4.129552 0.72691,-0.449253 -0.483,2.360094 -1.83546,4.261843 -0.36012,0.506376 -0.3688,0.500678 -0.20164,-0.132291 z", id: "path231" })))));
};

var CheckedShieldIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 -4 18 19" }, props),
        React.createElement(GiCheckedShield, null)));
};

var CoinsIcon = function (props) {
    return (React.createElement(Svg, __assign({}, props),
        React.createElement(FaCoins, null)));
};

var LogoutIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "-2 -1 14 14" }, props),
        React.createElement(FiLogOut, null)));
};

var GearIcon = function (props) {
    return (React.createElement(Svg, __assign({}, props),
...
var CustomIcon = function (props) {
    ...
    return React.createElement(Svg, __assign({}, rest), children);
};
...
var DropDownHeader = styled.div(templateObject_1$v || (templateObject_1$v = __makeTemplateObject(["\n  width: 100%;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0px 16px;\n  box-shadow: ", ";\n  border: 1px solid ", ";\n  border-radius: 6px;\n  background: ", ";\n  transition: border-radius 0.15s;\n"], ["\n  width: 100%;\n  height: 40px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0px 16px;\n  box-shadow: ", ";\n  border: 1px solid ", ";\n  border-radius: 6px;\n  background: ", ";\n  transition: border-radius 0.15s;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.shadows ? theme.colors.shadows.inset : theme.shadows.inset;
}, function (_a) {
    var theme = _a.theme;
...
var DropDownListContainer = styled.div(templateObject_2$i || (templateObject_2$i = __makeTemplateObject(["\n  min-width: 136px;\n  height: 0;\n  position: absolute;\n  overflow: hidden;\n  background: ", ";\n  z-index: ", ";\n  transition: transform 0.15s, opacity 0.15s;\n  transform: scaleY(0);\n  transform-origin: top;\n  opacity: 0;\n\n  ", " {\n    min-width: 168px;\n  }\n"], ["\n  min-width: 136px;\n  height: 0;\n  position: absolute;\n  overflow: hidden;\n  background: ", ";\n  z-index: ", ";\n  transition: transform 0.15s, opacity 0.15s;\n  transform: scaleY(0);\n  transform-origin: top;\n  opacity: 0;\n\n  ", " {\n    min-width: 168px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var DropDownContainer = styled.div(templateObject_4$9 || (templateObject_4$9 = __makeTemplateObject(["\n  cursor: pointer;\n  width: ", "px;\n  position: relative;\n  background: ", ";\n  border-radius: 6px;\n  height: 40px;\n  min-width: 136px;\n\n  ", " {\n    min-width: 168px;\n  }\n\n  ", "\n\n  svg {\n    position: absolute;\n    right: 16px;\n    top: 50%;\n    transform: translateY(-50%);\n  }\n"], ["\n  cursor: pointer;\n  width: ", "px;\n  position: relative;\n  background: ", ";\n  border-radius: 6px;\n  height: 40px;\n  min-width: 136px;\n\n  ", " {\n    min-width: 168px;\n  }\n\n  ", "\n\n  svg {\n    position: absolute;\n    right: 16px;\n    top: 50%;\n    transform: translateY(-50%);\n  }\n"])), function (_a) {
    var width = _a.width;
    return width;
}, function (_a) {
    var theme = _a.theme;
    ...
    return props.isOpen && css(templateObject_3$d || (templateObject_3$d = __makeTemplateObject(["\n      ", " {\n        border-bottom: 1px solid ", ";\n        box-shadow: ", ";\n        border-radius: 6px 6px 0 0;\n      }\n\n      ", " {\n        height: auto;\n        transform: scaleY(1);\n        opacity: 1;\n        border: 1px solid ", ";\n        border-top-width: 0;\n        border-radius: 0 0 6px 6px;\n        box-shadow: ", ";\n      }\n    "], ["\n      ", " {\n        border-bottom: 1px solid ", ";\n        box-shadow: ", ";\n        border-radius: 6px 6px 0 0;\n      }\n\n      ", " {\n        height: auto;\n        transform: scaleY(1);\n        opacity: 1;\n        border: 1px solid ", ";\n        border-top-width: 0;\n        border-radius: 0 0 6px 6px;\n        box-shadow: ", ";\n      }\n    "])), DropDownHeader, function (_a) {
        var theme = _a.theme;
        return theme.colors.inputSecondary;
    }, function (_a) {
        var theme = _a.theme;
        return theme.tooltip.boxShadow;
    }, DropDownListContainer, function (_a) {
        var theme = _a.theme;
        return theme.colors.inputSecondary;
    }, function (_a) {
        var theme = _a.theme;
...
var DropDownList = styled.ul(templateObject_5$6 || (templateObject_5$6 = __makeTemplateObject(["\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  z-index: ", ";\n"], ["\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  z-index: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.zIndices.dropdown;
});
...
var Select = function (_a) {
    var defaultOption = _a.defaultOption, options = _a.options, onChange = _a.onChange;
    var containerRef = useRef(null);
    var dropdownRef = useRef(null);
    var _b = useState(false), isOpen = _b[0], setIsOpen = _b[1];
    var _c = useState(defaultOption || options[0]), selectedOption = _c[0], setSelectedOption = _c[1];
    var _d = useState({ width: 0, height: 0 }), containerSize = _d[0], setContainerSize = _d[1];
    ...
    return (React.createElement(DropDownContainer, __assign({ isOpen: isOpen, ref: containerRef }, containerSize),
        containerSize.width !== 0 && (React.createElement(DropDownHeader, { onClick: toggling },
            React.createElement(Text, null, selectedOption.label))),
        React.createElement(Icon$1r, { color: "text", onClick: toggling }),
        React.createElement(DropDownListContainer, null,
            React.createElement(DropDownList, { ref: dropdownRef }, options.map(function (option) {
                return option.label !== selectedOption.label ? (React.createElement(ListItem, { onClick: onOptionClicked(option), key: option.label },
                    React.createElement(Text, null, option.label))) : null;
            })))));
};
var templateObject_1$v, templateObject_2$i, templateObject_3$d, templateObject_4$9, templateObject_5$6, templateObject_6$3;
...
var templateObject_1$u, templateObject_2$h, templateObject_3$c, templateObject_4$8, templateObject_5$5, templateObject_6$2, templateObject_7$2;
...
var ChildrenWrapper = styled(Box)(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n  ", " {\n    visibility: ", ";\n  }\n"], ["\n  ", " {\n    visibility: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, function (_a) {
...
var templateObject_1$s, templateObject_2$g, templateObject_3$b, templateObject_4$7, templateObject_5$4, templateObject_6$1, templateObject_7$1;
...
var getThemeTextColor = function (_a) {
    ...
    return outline ? getColor(variant, theme) : theme.colors.borderColor;
};
...
var Progress = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? variants.ROUND : _b, _c = _a.scale, scale = _c === void 0 ? scales$1.MD : _c, _d = _a.primaryStep, primaryStep = _d === void 0 ? 0 : _d, _e = _a.secondaryStep, secondaryStep = _e === void 0 ? null : _e, _f = _a.showProgressBunny, showProgressBunny = _f === void 0 ? false : _f;
...
var float = keyframes(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
var Container$2 = styled.div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$D)(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$E)(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var templateObject_1$n, templateObject_2$e, templateObject_3$a, templateObject_4$6;
...
var templateObject_1$m, templateObject_2$d, templateObject_3$9, templateObject_4$5, templateObject_5$3;
...
var duneColors = __assign(__assign(__assign({}, baseColors), brandColors), { primary: "#FFFFFA", primaryDark: "#A28BD4", success: "#a1654d", 
    // darker text
    secondary: "#edc891", 
    // dropdown/toggle back color
    tertiary: "#a1654d", background: "#1A202C", backgroundDisabled: "#3c3742", backgroundMenubar: "rgba(26, 32, 44, 0.8)", backgroundWallet: "#243047", farmBackground: "#EB8258", toggleBackground: "", contrast: "#ffdead", invertedContrast: "#191326", input: "#272e3b", inputSecondary: "#323c4d", text: "#FFFFFA", textDisabled: "#736551", 
    // row header text
    textSubtle: "#edc891", 
    // badge border
    borderColor: "#859BBA", card: "#2D3748", cardBorder: "", dropdown: "", dropdownAlt: "", alwaysWhite: "", 
    // button background color
    button: "#EB8258", 
    // menu background color
    nav: "#100C18", navHover: "#473d5d", 
...
var templateObject_1$j, templateObject_2$a, templateObject_3$7, templateObject_4$4;
...
styled.tspan(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n  letter-spacing: 0em;\n"], ["\n  font-size: 26.26px;\n  font-family: GoodTimingRg-Bold, Good Timing !important;\n  font-weight: 700;\n  letter-spacing: 0em;\n"])));
...
var Logo = function (_a) {
    ...
    return !isMobile ? (React.createElement(Flex, null,
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? React.createElement(Icon$y, { width: "24px", color: "textSubtle" }) : React.createElement(Icon$x, { width: "24px", color: "textSubtle" })),
        ...
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? (React.createElement(Icon$z, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$A, { width: "24px", color: "textSubtle" }))),
...
var rotate = keyframes(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n    0% { transform: translate(0,  0px); }\n    50%  { transform: translate(8px, 0); }\n    100%   { transform: translate(0, -0px); }  \n  }\n"], ["\n    0% { transform: translate(0,  0px); }\n    50%  { transform: translate(8px, 0); }\n    100%   { transform: translate(0, -0px); }  \n  }\n"])));
var NewIcon = styled(Icon$9)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate);
...
var templateObject_1$b, templateObject_2$5, templateObject_3$3, templateObject_4$3, templateObject_5$2, templateObject_6, templateObject_7;
...
var templateObject_1$9, templateObject_2$4, templateObject_3$2, templateObject_4$2, templateObject_5$1;
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "" + explorerUrl + account, mr: "16px" }, explorerText),
...
var useWalletModal = function (login, logout, explorerUrl, explorerText, connectUrl, account) {
...
var StyledWalletWrapper = styled.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  ", "\n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  ", "\n  ", "\n"])), space, size);
var StyledWalletButton = styled(Button)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  color: white;\n  background-color: ", ";\n  padding: 0 0.33rem;\n  height: ", ";\n  ", "\n"], ["\n  color: white;\n  background-color: ", ";\n  padding: 0 0.33rem;\n  height: ", ";\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.backgroundWallet;
}, function (_a) {
    var isNarrow = _a.isNarrow;
    return (isNarrow ? "50px" : "35px");
}, function (_a) {
    var isNarrow = _a.isNarrow;
    return isNarrow ? css(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n    height: 50px;\n  "], ["\n    height: 50px;\n  "]))) : css(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n    height: 35px;\n    margin-right: 0.75em;\n  "], ["\n    height: 35px;\n    margin-right: 0.75em;\n  "])));
});
var UserBlock = function (props) {
    ...
    var _a = useWalletModal(login, logout, explorerUrl, explorerText, connectUrl, account), onPresentConnectModal = _a.onPresentConnectModal, onPresentAccountModal = _a.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React.createElement(StyledWalletWrapper, __assign({}, rest), account ? (React.createElement(StyledWalletButton, { isNarrow: isNarrow, size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(StyledWalletButton, { size: "sm", onClick: function () {
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links; _a.profile; var explorerUrl = _a.explorerUrl, explorerText = _a.explorerText, connectUrl = _a.connectUrl, children = _a.children;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu, isPushed: isPushed },
            ...
            React.createElement(Flex, null, showMenu ? (React.createElement(UserBlock$1, { account: account, login: login, logout: logout, isDark: isDark, explorerUrl: explorerUrl, explorerText: explorerText, connectUrl: connectUrl })) : (React.createElement(React.Fragment, null)))),
...
var ResetCSS = createGlobalStyle(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  /* prettier-ignore */\n  html, body, div, span, applet, object, iframe,\n  h1, h2, h3, h4, h5, h6, p, blockquote, pre,\n  a, abbr, acronym, address, big, cite, code,\n  del, dfn, em, img, ins, kbd, q, s, samp,\n  small, strike, strong, sub, sup, tt, var,\n  b, u, i, center,\n  dl, dt, dd, ol, ul, li,\n  fieldset, form, label, legend,\n  table, caption, tbody, tfoot, thead, tr, th, td,\n  article, aside, canvas, details, embed, \n  figure, figcaption, footer, header, hgroup, \n  menu, nav, output, ruby, section, summary,\n  time, mark, audio, video {\n    margin: 0;\n    padding: 0;\n    border: 0;\n    font-size: 100%;\n    vertical-align: baseline;\n  }\n  /* HTML5 display-role reset for older browsers */\n  /* prettier-ignore */\n  article, aside, details, figcaption, figure, \n  footer, header, hgroup, menu, nav, section {\n    display: block;\n  }\n  body {\n    line-height: 1;\n    font-size: 16px;\n  }\n  ol,\n  ul {\n    list-style: disc;\n    list-style-position: inside;\n  }\n  blockquote,\n  q {\n    quotes: none;\n  }\n  blockquote:before,\n  blockquote:after,\n  q:before,\n  q:after {\n    content: \"\";\n    content: none;\n  }\n  table {\n    border-collapse: collapse;\n    border-spacing: 0;\n  }\n  a {\n    color: inherit;\n    text-decoration: none;\n  }\n  [role=\"button\"] {\n    cursor: pointer;\n  }\n  *,\n  *::before,\n  *::after {\n    box-sizing: border-box;\n  }\n  * {\n    font-family: 'Kanit', sans-serif;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n  /* Scrollbar */\n  ::-webkit-scrollbar {\n    width: 8px;\n  }\n  ::-webkit-scrollbar-thumb {\n    background: ", "; \n    border-radius: 8px;\n  }\n  ::-webkit-scrollbar-track {\n    box-shadow: inset 0 0 5px ", "; \n    border-radius: 10px;\n  }\n"], ["\n  /* prettier-ignore */\n  html, body, div, span, applet, object, iframe,\n  h1, h2, h3, h4, h5, h6, p, blockquote, pre,\n  a, abbr, acronym, address, big, cite, code,\n  del, dfn, em, img, ins, kbd, q, s, samp,\n  small, strike, strong, sub, sup, tt, var,\n  b, u, i, center,\n  dl, dt, dd, ol, ul, li,\n  fieldset, form, label, legend,\n  table, caption, tbody, tfoot, thead, tr, th, td,\n  article, aside, canvas, details, embed, \n  figure, figcaption, footer, header, hgroup, \n  menu, nav, output, ruby, section, summary,\n  time, mark, audio, video {\n    margin: 0;\n    padding: 0;\n    border: 0;\n    font-size: 100%;\n    vertical-align: baseline;\n  }\n  /* HTML5 display-role reset for older browsers */\n  /* prettier-ignore */\n  article, aside, details, figcaption, figure, \n  footer, header, hgroup, menu, nav, section {\n    display: block;\n  }\n  body {\n    line-height: 1;\n    font-size: 16px;\n  }\n  ol,\n  ul {\n    list-style: disc;\n    list-style-position: inside;\n  }\n  blockquote,\n  q {\n    quotes: none;\n  }\n  blockquote:before,\n  blockquote:after,\n  q:before,\n  q:after {\n    content: \"\";\n    content: none;\n  }\n  table {\n    border-collapse: collapse;\n    border-spacing: 0;\n  }\n  a {\n    color: inherit;\n    text-decoration: none;\n  }\n  [role=\"button\"] {\n    cursor: pointer;\n  }\n  *,\n  *::before,\n  *::after {\n    box-sizing: border-box;\n  }\n  * {\n    font-family: 'Kanit', sans-serif;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n  }\n  /* Scrollbar */\n  ::-webkit-scrollbar {\n    width: 8px;\n  }\n  ::-webkit-scrollbar-thumb {\n    background: ", "; \n    border-radius: 8px;\n  }\n  ::-webkit-scrollbar-track {\n    box-shadow: inset 0 0 5px ", "; \n    border-radius: 10px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.thumb;
}, function (_a) {
    var theme = _a.theme;
    return theme.colors.thumbAlt;
});
var templateObject_1;

export { Icon$1u as AddIcon, Alert, Icon$1t as ArrowBackIcon, Icon$1s as ArrowDownIcon, Icon$1r as ArrowDropDownIcon, Icon$1q as ArrowDropUpIcon, Icon$1p as ArrowForwardIcon, Icon$1o as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1n as BinanceIcon, Icon$1w as BlockIcon, Box, Breadcrumbs, Icon$1m as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$1k as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1l as CardViewIcon, GridLayout as CardsLayout, Icon$1j as ChartIcon, Checkbox, CheckedShieldIcon, Icon$1y as CheckmarkCircleIcon, Icon$1i as CheckmarkIcon, Icon$1h as ChevronDownIcon, Icon$1g as ChevronLeftIcon, Icon$1f as ChevronRightIcon, Icon$1e as ChevronUpIcon, Icon$1d as CloseIcon, Icon$1c as CogIcon, CoinsIcon, Icon$1b as CommunityIcon, ConnectorNames, Icon$1a as CopyIcon, CustomIcon, Dropdown, EXPBottleIcon, Icon$1x as ErrorIcon, FallingBunnies, Icon$19 as FarmIcon, Flex, GearIcon, Heading, Icon$18 as HelpIcon, Icon$17 as HomeIcon, IconButton, Image, Icon$1v as InfoIcon, Input$1 as Input, Icon$16 as LanguageIcon, Link, LinkExternal, Icon$15 as ListViewIcon, Icon$14 as LogoIcon, Icon$13 as LogoRoundIcon, LogoutIcon, Menu, Icon$12 as MetamaskIcon, Icon$11 as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$10 as MoreIcon, Icon$$ as NftIcon, Icon$_ as NoProfileAvatarIcon, NotificationDot, Icon$Z as OpenNewIcon, Icon$X as PancakeRoundIcon, Icon$Y as PancakesIcon, Icon$W as PocketWatchIcon, Icon$V as PrizeIcon, Progress, Icon$R as ProgressBunny, Radio, Icon$U as RefreshIcon, Icon$T as RemoveIcon, ResetCSS, Icon$K as SearchIcon, Select, Skeleton, Slider, Spinner, Step, Stepper, Svg, Icon$J as SwapVertIcon, Icon$I as SyncAltIcon, Tag, Icon$P as TelegramIcon, Text, Icon$F as ThunderBgIcon, Icon$G as ThunderIcon, Icon$O as Ticket, Icon$N as TicketRound, ToastContainer, Toggle, TooltipText, Icon$M as TradeIcon, Icon$L as TwitterIcon, UserBlock$1 as UserBlock, Icon$S as VerifiedIcon, Icon$H as WarningIcon, Icon$Q as Won, variants$1 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, duneTheme as dune, duneColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useTooltip, useWalletModal };
